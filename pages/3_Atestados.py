...
class CustomPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, txt = "Dra. Monyque Cunha Trindade", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align = 'C')
        self.cell(0, 10, txt = "CIRURGIA BUCOMAXILOFACIAL", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align = 'C')
...
def main():
    ...
    doc_type = st.selectbox('Atestado ou Declaração', ['Atestado', 'Declaração'])
